...
setwd("C:/Users/User/Dropbox/SoybeanProject4741/Data_Visualization")
...
locationRM <- read.csv("ExpectedRM.csv")

p6 <- ggplot(locationRM, aes(x = locationRM$ExpectedRM, y = locationRM$AvgRM))+geom_point() + xlab("Location's Expected RM") + ylab("Location's Average RM")
p6
