...
training_1 = read.table("../Split_Data3/training[1].csv",sep=",",header=TRUE);
testing_1 = read.table("../Split_Data3/test_2010.csv",sep=",",header=TRUE);
...
training_2 = read.table("../Split_Data3/training[2].csv",sep=",",header=TRUE);
testing_2 = read.table("../Split_Data3/test_2011.csv",sep=",",header=TRUE);
...
#####################################3###########################################
# Starts becoming bad
training_3 = read.table("../Split_Data3/training[3].csv",sep=",",header=TRUE);
testing_3 = read.table("../Split_Data3/test_2012.csv",sep=",",header=TRUE);
...
#####################################4###########################################
# Starts becoming bad
training_4 = read.table("../Split_Data3/training[4].csv",sep=",",header=TRUE);
testing_4 = read.table("../Split_Data3/test_2013.csv",sep=",",header=TRUE);
...
#####################################5###########################################
# Starts becoming bad
training_5 = read.table("../Split_Data3/training[5].csv",sep=",",header=TRUE);
testing_5 = read.table("../Split_Data3/test_2014.csv",sep=",",header=TRUE);
...
predictionData = read.table("../Split_Data3/prediction_set.csv",sep=",",header=TRUE);
