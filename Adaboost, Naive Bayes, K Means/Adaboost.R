...
print(paste("Avg precision is", toString(avgPrecision)));
print(paste("Avg recall is",  toString(avgRecall)));
...
print(paste("Best model is",toString(best))); # best model is 2
...
#### WRITE CSV ################
testing1 <- subset( testing_1,select=c("YEAR","VARIETY","CHECK","RM", "YIELD","FAM_SEGMENT1","FAM_SEGMENT2","FAM_SEGMENT3","FAM_SEGMENT4","FAM_SEGMENT5","CLASS_OF", "GRAD" ));
testing1 = testing1[testing1$GRAD != -1,];
testing1$GRAD <- factor(testing1$GRAD); 
pred1Vec <- array(pred1$class);
testing1new <- cbind(testing1,pred1Vec);
write.csv(testing1new, file = "testing[2010]_fit.csv");


testing2 <- subset( testing_2,select=c("YEAR","VARIETY","CHECK","RM", "YIELD","FAM_SEGMENT1","FAM_SEGMENT2","FAM_SEGMENT3","FAM_SEGMENT4","FAM_SEGMENT5","CLASS_OF", "GRAD" ));
testing2 = testing2[testing2$GRAD != -1,];
testing2$GRAD <- factor(testing2$GRAD); 
pred2Vec <- array(pred2$class);
testing2new <- cbind(testing2,pred2Vec);
write.csv(testing2new, file = "testing[2011]_fit.csv");

testing3 <- subset( testing_3,select=c("YEAR","VARIETY","CHECK","RM", "YIELD","FAM_SEGMENT1","FAM_SEGMENT2","FAM_SEGMENT3","FAM_SEGMENT4","FAM_SEGMENT5","CLASS_OF", "GRAD" ));
testing3 = testing3[testing3$GRAD != -1,];
testing3$GRAD <- factor(testing3$GRAD); 
pred3Vec <- array(pred3$class);
testing3new <- cbind(testing3,pred3Vec);
write.csv(testing3new, file = "testing[2012]_fit.csv");

testing4 <- subset( testing_4,select=c("YEAR","VARIETY","CHECK","RM", "YIELD","FAM_SEGMENT1","FAM_SEGMENT2","FAM_SEGMENT3","FAM_SEGMENT4","FAM_SEGMENT5","CLASS_OF", "GRAD" ));
testing4 = testing4[testing4$GRAD != -1,];
testing4$GRAD <- factor(testing4$GRAD); 
pred4Vec <- array(pred4$class);
testing4new <- cbind(testing4,pred4Vec);
write.csv(testing4new, file = "testing[2013]_fit.csv");

testing5 <- subset( testing_5,select=c("YEAR","VARIETY","CHECK","RM", "YIELD","FAM_SEGMENT1","FAM_SEGMENT2","FAM_SEGMENT3","FAM_SEGMENT4","FAM_SEGMENT5","CLASS_OF", "GRAD" ));
testing5 = testing5[testing5$GRAD != -1,];
testing5$GRAD <- factor(testing5$GRAD); 
pred5Vec <- array(pred5$class);
testing5new <- cbind(testing5,pred5Vec);
write.csv(testing5new, file = "testing[2014]_fit.csv");
